...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        ...
        this.host = host;
        this.port = port;
        setTitle("You are logged in with userName " + username);
    ...
    public void connect(){
        ...
        try {
            ...
            dos = new DataOutputStream(socket.getOutputStream());//client can send data to server
            
            dos.writeUTF("CMD_JOIN "+ username);//send msg to server that client connected
    ...
    */
    ...
    private void initComponents() {
        ...
        jTextPane1.setFont(new java.awt.Font("Segoe UI Semibold", 1, 36)); // NOI18N
        jTextPane1.setForeground(new java.awt.Color(255, 102, 255));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/msg (1).png"))); // NOI18N

        jLabel1.setBackground(new java.awt.Color(255, 153, 153));
        jLabel1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel1.setText("           Online list");

        txtpane2.setBackground(new java.awt.Color(204, 204, 255));
        txtpane2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    ...
    private void sendFileMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendFileMenuActionPerformed
        ...
        if(!attachmentOpen){
            ...
            if(s.prepare(username, host, port, this)){
                ...
                JOptionPane.showMessageDialog(this, "Unable to set up File Sharing at this time, please try again later.!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        try {
            ...
            appendMessage(" Unable to send message now, unable to connect to Server at this time, please try again later or restart this application.!", "Error", Color.RED, Color.RED);
        }
